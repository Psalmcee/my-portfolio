  ...
  return (
    <footer className="py-12 bg-gray-300 text-black">
      <div className="flex flex-col items-start gap-8 lg:justify-left text-left max-w-6xl md:px-6 mx-auto">
        ...
        <Link
          href={"/contact"}
          className="mb-8 md:mb-0 ml-3 text-center md:text-left gap-1 flex-1 flex flex-row"
        >
          Contact Us Now
      ...
      <div className="max-w-6xl mx-auto px-4 mt-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="rounded-lg p-6 bg-gradient-to-br from-gray-900/70 to-gray-700/40 backdrop-blur-lg">
              <Link
                href="/"
                className="flex items-start md:mr-10 whitespace-nowrap font-bold focus:outline-none pl-0"
                aria-label="Homepage"
              >
                <span className="block w-auto h-20 relative -ml-2">
                  <Image
                    src="/axiom-logo.png"
                    alt="Axiom Tech Labs"
                    width={110}
              ...
              <p className="text-sm text-gray-800">
                We design bold, conversion-driven websites that elevate your
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <p>
            © {new Date().getFullYear()} Axiom Tech Labs. All rights reserved.
          </p>
        </div>
      </div>
