    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center flex flex-col items-center justify-center h-full min-h-[60vh]">
        <motion.h1
          ...
          className={`${abril.className} text-5xl md:text-7xl font-medium mb-4`}
        >
          <span
        ...
        <div className="flex justify-center gap-4">
          ...
          >
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-2 bg-amber-600 text-white rounded-full shadow-xl hover:scale-105 transform transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-amber-200"
            >
          ...
          <motion.div
            ...
            className="inline-flex"
          >
            <Link href="/pricing" className="px-6 py-2 border bg-white/90 text-amber-700 hover:bg-amber-700 hover:text-white border-amber-200 rounded-full transition-colors duration-200 font-semibold flex items-center justify-center">
